...
/**
 * Strings for component 'block_courseadmin', language 'en', branch 'MOODLE_20_STABLE'
 *
...
$string['html:addinstance'] = 'Add a new Course Admin block';
$string['html:myaddinstance'] = 'Add a new Course Admin to My home';
