...
$pdf->SetTextColor(97,50,96);
certificate_print_text($pdf, $x, $y + 30, 'C', 'Helvetica', '', 32, fullname($USER));
...
certificate_print_text($pdf, $x, $y + 94, 'C', 'Helvetica', '', 16, certificate_get_date($certificate, $certrecord, $course));
$pdf->SetTextColor(0,0,0);
