...
$pdf->SetTextColor(24,165,165);
certificate_print_text($pdf, $x, $y + 35, 'C', 'Helvetica', '', 32, fullname($USER));
...
//$pdf->SetTextColor(0,100,97);
certificate_print_text($pdf, $x, $y + 100, 'C', 'Helvetica', '', 16, certificate_get_date($certificate, $certrecord, $course));
...
if ($certificate->printhours) {
    certificate_print_text($pdf, $x, $y + 80, 'C', 'Helvetica', '', 10, get_string('credithours', 'certificate') . ': ' . $certificate->printhours);
}
$pdf->SetTextColor(8,61,68);
certificate_print_text($pdf, $x + 249, $y + 165, 'C', 'Helvetica', '', 10, certificate_get_code($certificate, $certrecord));
$i = 0;
