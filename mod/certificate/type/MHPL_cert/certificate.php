...
$pdf->SetTextColor(204,133,133);
certificate_print_text($pdf, $x, $y + 34, 'C', 'Helvetica', '', 32, fullname($USER));
...
$pdf->SetTextColor(204,133,133);
certificate_print_text($pdf, $x, $y + 95, 'C', 'Helvetica', '', 16, certificate_get_date($certificate, $certrecord, $course));
...
$pdf->SetTextColor(126,124,130);
certificate_print_text($pdf, $x+230, $codey, 'C', 'Helvetica', '', 10, certificate_get_code($certificate, $certrecord));
$i = 0;
