...
$string['tsblog:view'] = 'Ver mensajes';
$string['tsblog:post'] = 'Crear nuevo mensaje';
$string['tsblog:comment'] = 'Comentar un mensaje';
$string['tsblog:managecomments'] = 'Gestionar comentarios';
$string['tsblog:manageposts'] = 'Gestionar mensajes';
$string['tsblog:managelinks'] = 'Gestionar vínculos';
$string['tsblog:audit'] = 'Ver mensajes eliminados y versiones anteriores';
