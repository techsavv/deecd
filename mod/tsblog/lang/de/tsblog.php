...
$string['tsblog:view'] = 'Beiträge anschauen';
$string['tsblog:viewpersonal'] = 'Beiträge anschauen in den persönlichen Blogs';
$string['tsblog:contributepersonal'] = 'In persönlichen Blogs verschicken und kommentieren';
$string['tsblog:post'] = 'Einen neuen Beitrag erstellen';
$string['tsblog:comment'] = 'Kommentar zu einem Beitrag';
$string['tsblog:managecomments'] = 'Kommentare verwalten';
$string['tsblog:manageposts'] = 'Beiträge verwalten';
$string['tsblog:managelinks'] = 'Links verwalten';
$string['tsblog:audit'] = 'Gelöschte Beiträge und alte Versionen anschauen';
