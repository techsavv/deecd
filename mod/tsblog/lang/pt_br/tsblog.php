...
$string['tsblog'] = 'OU blog';
$string['tsblog:audit'] = 'Visualizar mensagens apagadas e versões velhas';
$string['tsblog:comment'] = 'Comentar uma mensagem';
$string['tsblog:contributepersonal'] = 'Poste e comente nos blogs pessoais';
$string['tsblog:exportownpost'] = 'Exportar proprias mensagens';
$string['tsblog:exportpost'] = 'Exportar mensagens';
$string['tsblog:managecomments'] = 'Administrar comentários';
$string['tsblog:managelinks'] = 'Administrar links';
$string['tsblog:manageposts'] = 'Administrar mensagens';
$string['tsblog:post'] = 'Crie uma nova mensagem';
$string['tsblog:view'] = 'Visualizar mensagem';
$string['tsblog:viewindividual'] = 'Blogs individuais visíveis';
$string['tsblog:viewpersonal'] = 'Visualizar mensagens de blogs pessoais';
...
$string['pluginadministration'] = 'Administração do TS Blog';
