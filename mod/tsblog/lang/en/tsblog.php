...
$string['tsblog'] = 'TS blog';
$string['modulename'] = 'TS blog';
$string['modulenameplural'] = 'TS blogs';
...
$string['tsblogintro'] = 'Intro';

$string['tsblog:view'] = 'View posts';
$string['tsblog:addinstance'] = 'Add a new TS blog';
$string['tsblog:viewpersonal'] = 'View posts in personal blogs';
$string['tsblog:viewprivate'] = 'View private posts in personal blogs';
$string['tsblog:contributepersonal'] = 'Post and comment in personal blogs';
$string['tsblog:post'] = 'Create a new post';
$string['tsblog:comment'] = 'Comment on a post';
$string['tsblog:managecomments'] = 'Manage comments';
$string['tsblog:manageposts'] = 'Manage posts';
$string['tsblog:managelinks'] = 'Manage links';
$string['tsblog:audit'] = 'View deleted posts and old versions';
$string['tsblog:viewindividual'] = 'View individual blogs';
$string['tsblog:exportownpost'] = 'Export own post';
$string['tsblog:exportpost'] = 'Export post';
$string['tsblog:exportposts'] = 'Export posts';
...
$string['tsblogallpostslogin'] = 'Force login on all posts page';
$string['tsblogallpostslogin_desc'] = 'Enable to force login to the personal blog site entries page.
...
$string['computingguide']='Guide to TS blogs';
$string['computingguideurl']='Computing guide URL';
$string['computingguideurlexplained']='Enter the URL for the TS blogs omputing guide';
...
$string['displayversion'] = 'TS blog version: <strong>{$a}</strong>';

$string['pluginadministration'] = 'TS Blog administration';
$string['pluginname'] = 'TS Blog';
// Help strings.
...
// User participation.
$string['tsblog:grade'] = 'Grade TS Blog user participation';
$string['tsblog:viewparticipation'] = 'View TS Blog user participation';
...
$string['configremotetoken'] = 'Web service user token for tsblog webservices on import remote server.';
...
about issues with posts or comments within the TSBlog.
They should be entered as a comma separated list.';
$string['postalert'] = 'Report post';
$string['commentalert'] = 'Report comment';
$string['tsblog_managealerts'] = 'Manage reported post/comment alerts';
