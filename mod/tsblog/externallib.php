...
class mod_tsblog_external extends external_api {
    ...
    public static function get_user_blogs($username) {
        ...
        $result = tsblog_import_getblogs($user);
    ...
    public static function get_blog_info($cmid, $username) {
        ...
        $result = tsblog_import_getbloginfo($params['cmid'], $user);
        return array(
                'bcmid' => $result[0],
                'btsblogid' => $result[1],
                'bcontextid' => $result[2],
                'btsblogname' => $result[3],
    ...
    public static function get_blog_info_returns() {
        return new external_single_structure(
                array(
                        ...
                        'btsblogid' => new external_value(PARAM_INT, 'Blog id'),
                        'bcontextid' => new external_value(PARAM_INT, 'Blog context id'),
                        'btsblogname' => new external_value(PARAM_TEXT, 'Blog name'),
    ...
    public static function get_blog_allposts($blogid, $sort, $username, $page = 0, $tags = null) {
        ...
        $result = tsblog_import_getallposts($params['blogid'], $params['sort'], $user,
    ...
    public static function get_blog_posts($blogid, $bcontextid, $selected, $inccomments = false, $username) {
        ...
        $return = tsblog_import_getposts($params['blogid'], $params['bcontextid'],
    ...
    public static function get_blog_posts_returns() {
        return new external_multiple_structure(new external_single_structure(array(
                'id' => new external_value(PARAM_INT, 'post id'),
                'tsbloginstancesid' => new external_value(PARAM_INT, 'instance id'),
