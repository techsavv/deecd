...
/**
 * Strings for component 'theme_deecdbase', language 'en', branch 'MOODLE_20_STABLE'
 *
 * @package   moodlecore
...
$string['not_edumail_error'] = 'Your email must be an edumail account (user@edumail.vic.gov.au)';