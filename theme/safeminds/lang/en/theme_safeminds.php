...
/* Core */
$string['configtitle'] = 'safeminds';
$string['pluginname'] = 'safeminds';
$string['choosereadme'] = '
<div class="clearfix">
<div class="well">
<h2>safeminds</h2>
<p><img class=img-polaroid src="safeminds/pix/screenshot.jpg" /></p>
</div>
<div class="well">
<h3>About safeminds</h3>
<p>safeminds is a modified Moodle bootstrap theme which inherits styles and renderers from its parent theme.</p>
<h3>Parents</h3>
