...
<head>
    ...
    <noscript>
			<link rel="stylesheet" type="text/css" href="<?php echo $CFG->wwwroot;?>/theme/safeminds/style/nojs.css" />
	</noscript>
    <!-- Google web fonts -->
...
<!-- End Frontpage Content -->
	...
	<div class="hidden-blocks">
    	<div class="row-fluid">
        	<h4><?php echo get_string('visibleadminonly', 'theme_safeminds') ?></h4>
            <?php
                echo $OUTPUT->safemindsblocks('hidden-dock');
            ?>
    	</div>
	</div>
	<?php } ?>
