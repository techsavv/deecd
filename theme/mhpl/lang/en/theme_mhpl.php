...
/* Core */
$string['configtitle'] = 'mhpl';
$string['pluginname'] = 'mhpl';
$string['choosereadme'] = '
<div class="clearfix">
<div class="well">
<h2>mhpl</h2>
<p><img class=img-polaroid src="mhpl/pix/screenshot.jpg" /></p>
</div>
<div class="well">
<h3>About mhpl</h3>
<p>mhpl is a modified Moodle bootstrap theme which inherits styles and renderers from its parent theme.</p>
<h3>Parents</h3>
...
$string['editpostpageintro']='Using the prompts in the module content, enter a title
    and a message to your blog post below. When you\'re done, scroll down and click the \'Add post\' button.';
