...
defined('MOODLE_INTERNAL') || die;
	...
	$temp = new admin_settingpage('theme_essential2_generic',  get_string('geneicsettings', 'theme_essential2'));
    ...
    $name = 'theme_essential2/headerprofilepic';
    $title = get_string('headerprofilepic', 'theme_essential2');
    $description = get_string('headerprofilepicdesc', 'theme_essential2');
    $default = true;
    ...
    $default = 1200;
    $choices = array(1900=>get_string('fixedwidthwide','theme_essential2'), 1200=>get_string('fixedwidthnarrow','theme_essential2'), 100=>get_string('variablewidth','theme_essential2'));
    $setting = new admin_setting_configselect($name, $title, $description, $default, $choices);
    $setting->set_updatedcallback('theme_reset_all_caches');
    $temp->add($setting);
    ...
    $name = 'theme_essential2/editicons';
    $title = get_string('editicons', 'theme_essential2');
    $description = get_string('editiconsdesc', 'theme_essential2');
    $setting = new admin_setting_configcheckbox($name, $title, $description, 0);
    $temp->add($setting);
    
    //Include the Autohide css rules
    $name = 'theme_essential2/autohide';
    $visiblename = get_string('autohide', 'theme_essential2');
    $title = get_string('autohide', 'theme_essential2');
    $description = get_string('autohidedesc', 'theme_essential2');
    ...
    // Navbar Seperator.
    $name = 'theme_essential2/navbarsep';
    $title = get_string('navbarsep' , 'theme_essential2');
    $description = get_string('navbarsepdesc', 'theme_essential2');
    $nav_thinbracket = get_string('nav_thinbracket', 'theme_essential2');
    $nav_doublebracket = get_string('nav_doublebracket', 'theme_essential2');
    $nav_thickbracket = get_string('nav_thickbracket', 'theme_essential2');
    $nav_slash = get_string('nav_slash', 'theme_essential2');
    $nav_pipe = get_string('nav_pipe', 'theme_essential2');
    ...
    $temp = new admin_settingpage('theme_essential2_custommenu', get_string('custommenuheading', 'theme_essential2'));
	            
    //This is the descriptor for the following Moodle color settings
    $name = 'theme_essential2/mydashboardinfo';
    $heading = get_string('mydashboardinfo', 'theme_essential2');
    $information = get_string('mydashboardinfodesc', 'theme_essential2');
    $setting = new admin_setting_heading($name, $heading, $information);
    $temp->add($setting);
    
    // Toggle dashboard display in custommenu.
    $name = 'theme_essential2/displaymydashboard';
    $title = get_string('displaymydashboard', 'theme_essential2');
    $description = get_string('displaymydashboarddesc', 'theme_essential2');
    $default = true;
    $setting = new admin_setting_configcheckbox($name, $title, $description, $default, true, false);
    $setting->set_updatedcallback('theme_reset_all_caches');
    $temp->add($setting);
    ...
    $name = 'theme_essential2/slidecolorinfo';
    $heading = get_string('slidecolors', 'theme_essential2');
    $information = get_string('slidecolorsdesc', 'theme_essential2');
    $setting = new admin_setting_heading($name, $heading, $information);
    $temp->add($setting);
    
      // Slide Header colour setting.
    $name = 'theme_essential2/slideheadercolor';
    $title = get_string('slideheadercolor', 'theme_essential2');
    $description = get_string('slideheadercolordesc', 'theme_essential2');
    $default = '#30add1';
    $previewconfig = null;
    $setting = new admin_setting_configcolourpicker($name, $title, $description, $default, $previewconfig);
    $setting->set_updatedcallback('theme_reset_all_caches');
    ...
    $display = get_string('alwaysdisplay', 'theme_essential2');
    $dontdisplay = get_string('dontdisplay', 'theme_essential2');
    $default = 'display';
    ...
    $name = 'theme_essential2/slideshowvariant';
    $title = get_string('slideshowvariant' , 'theme_essential2');
    $description = get_string('slideshowvariantdesc', 'theme_essential2');
    $slideshow1 = get_string('slideshow1', 'theme_essential2');
    $slideshow2 = get_string('slideshow2', 'theme_essential2');
    $default = 'slideshow1';
    ...
    $name = 'theme_essential2/slide1info';
    $heading = get_string('slide1', 'theme_essential2');
    $information = get_string('slideinfodesc', 'theme_essential2');
    $setting = new admin_setting_heading($name, $heading, $information);
    $temp->add($setting);

    // Title.
    $name = 'theme_essential2/slide1';
    ...
    // Image.
    $name = 'theme_essential2/slide1image';
    ...
    // Caption.
    $name = 'theme_essential2/slide1caption';
    ...
    // URL.
    $name = 'theme_essential2/slide1url';
    ...
    $name = 'theme_essential2/slide2info';
    $heading = get_string('slide2', 'theme_essential2');
    $information = get_string('slideinfodesc', 'theme_essential2');
    $setting = new admin_setting_heading($name, $heading, $information);
    $temp->add($setting);

    // Title.
    $name = 'theme_essential2/slide2';
    $title = get_string('slidetitle', 'theme_essential2');
    $description = get_string('slidetitledesc', 'theme_essential2');
    $setting = new admin_setting_configtext($name, $title, $description, '');
    $default = '';
    ...
    // Image.
    $name = 'theme_essential2/slide2image';
    $title = get_string('slideimage', 'theme_essential2');
    $description = get_string('slideimagedesc', 'theme_essential2');
    ...
    // Caption.
    $name = 'theme_essential2/slide2caption';
    $title = get_string('slidecaption', 'theme_essential2');
    $description = get_string('slidecaptiondesc', 'theme_essential2');
    $setting = new admin_setting_configtextarea($name, $title, $description, '');
    $setting->set_updatedcallback('theme_reset_all_caches');
    ...
    // URL.
    $name = 'theme_essential2/slide2url';
    $title = get_string('slideurl', 'theme_essential2');
    $description = get_string('slideurldesc', 'theme_essential2');
    $setting = new admin_setting_configtext($name, $title, $description, '', PARAM_URL);
    $setting->set_updatedcallback('theme_reset_all_caches');
    ...
    $name = 'theme_essential2/slide3info';
    $heading = get_string('slide3', 'theme_essential2');
    $information = get_string('slideinfodesc', 'theme_essential2');
    $setting = new admin_setting_heading($name, $heading, $information);
    $temp->add($setting);
    
    // Title.
    $name = 'theme_essential2/slide3';
    $title = get_string('slidetitle', 'theme_essential2');
    $description = get_string('slidetitledesc', 'theme_essential2');
    $setting = new admin_setting_configtext($name, $title, $description, '');
    $default = '';
    ...
    // Image.
    $name = 'theme_essential2/slide3image';
    $title = get_string('slideimage', 'theme_essential2');
    $description = get_string('slideimagedesc', 'theme_essential2');
    ...
    // Caption.
    $name = 'theme_essential2/slide3caption';
    $title = get_string('slidecaption', 'theme_essential2');
    $description = get_string('slidecaptiondesc', 'theme_essential2');
    $setting = new admin_setting_configtextarea($name, $title, $description, '');
    $setting->set_updatedcallback('theme_reset_all_caches');
    ...
    // URL.
    $name = 'theme_essential2/slide3url';
    $title = get_string('slideurl', 'theme_essential2');
    $description = get_string('slideurldesc', 'theme_essential2');
    $setting = new admin_setting_configtext($name, $title, $description, '', PARAM_URL);
    $setting->set_updatedcallback('theme_reset_all_caches');
    ...
    $name = 'theme_essential2/slide4info';
    $heading = get_string('slide4', 'theme_essential2');
    $information = get_string('slideinfodesc', 'theme_essential2');
    $setting = new admin_setting_heading($name, $heading, $information);
    $temp->add($setting);

    // Title.
    $name = 'theme_essential2/slide4';
    $title = get_string('slidetitle', 'theme_essential2');
    $description = get_string('slidetitledesc', 'theme_essential2');
    $setting = new admin_setting_configtext($name, $title, $description, '');
    $default = '';
    ...
    // Image.
    $name = 'theme_essential2/slide4image';
    $title = get_string('slideimage', 'theme_essential2');
    $description = get_string('slideimagedesc', 'theme_essential2');
    ...
    // Caption.
    $name = 'theme_essential2/slide4caption';
    $title = get_string('slidecaption', 'theme_essential2');
    $description = get_string('slidecaptiondesc', 'theme_essential2');
    $setting = new admin_setting_configtextarea($name, $title, $description, '');
    $setting->set_updatedcallback('theme_reset_all_caches');
    ...
    // URL.
    $name = 'theme_essential2/slide4url';
    $title = get_string('slideurl', 'theme_essential2');
    $description = get_string('slideurldesc', 'theme_essential2');
    $setting = new admin_setting_configtext($name, $title, $description, '', PARAM_URL);
    $setting->set_updatedcallback('theme_reset_all_caches');
    ...
    $temp = new admin_settingpage('theme_essential2_frontcontent', get_string('frontcontentheading', 'theme_essential2'));
	$temp->add(new admin_setting_heading('theme_essential2_frontcontent', get_string('frontcontentheadingsub', 'theme_essential2'),
            format_text(get_string('frontcontentdesc' , 'theme_essential2'), FORMAT_MARKDOWN)));
    
    // Enable Frontpage Content
    $name = 'theme_essential2/usefrontcontent';
    $title = get_string('usefrontcontent', 'theme_essential2');
    $description = get_string('usefrontcontentdesc', 'theme_essential2');
    $default = false;
    $setting = new admin_setting_configcheckbox($name, $title, $description, $default, true, false);
    $setting->set_updatedcallback('theme_reset_all_caches');
    $temp->add($setting);
	...
	$temp = new admin_settingpage('theme_essential2_marketing', get_string('marketingheading', 'theme_essential2'));
	...
	$temp = new admin_settingpage('theme_essential2_social', get_string('socialheading', 'theme_essential2'));
    ...
    $temp = new admin_settingpage('theme_essential2_mobileapps', get_string('mobileappsheading', 'theme_essential2'));
    ...
    /* User Alerts */
    $temp = new admin_settingpage('theme_essential2_alerts', get_string('alertsheading', 'theme_essential2'));
