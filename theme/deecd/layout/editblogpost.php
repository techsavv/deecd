...
/**
 * The deecd theme is built upon the Bootstrapbase theme.
 *
 * @package    theme
 * @subpackage deecd
...
<div id="page" class="container-fluid">
        ...
        <div id="<?php echo $regionbsid ?>" class="span9">
            <div class="row-fluid">
                ...
                <?php } ?>
                    ...
                    <?php  echo html_writer::tag('p', print_string('editpostpageintro','theme_deecd')); ?>
                    <!--/*END CHANGE*/-->
                    <?php
    ...
    <a href="#top" class="back-to-top"><i class="fa fa-chevron-circle-up fa-3x"></i><p><?php print_string('backtotop', 'theme_deecd'); ?></p></a>
