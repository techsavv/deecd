...
?>
    ...
    <?php if ($hasslide3) { ?>
        <div class="da-slide">
            ...
            <?php } ?>
            <?php if ($hasslide3url) { ?>
                <a href="<?php echo $slide3url ?>" class="da-link"><?php echo get_string('readmore','theme_mhpl')?></a>
            <?php } ?>
    ...
    <?php if ($hasslide4) { ?>
        <div class="da-slide">
            ...
            <?php } ?>
            <?php if ($hasslide4url) { ?>
                <a href="<?php echo $slide4url ?>" class="da-link"><?php echo get_string('readmore','theme_mhpl')?></a>
            <?php } ?>
