...
/* Core */
$string['configtitle'] = 'deecd';
$string['pluginname'] = 'deecd';
$string['choosereadme'] = '
<div class="clearfix">
<div class="well">
<h2>deecd</h2>
<p><img class=img-polaroid src="deecd/pix/screenshot.jpg" /></p>
</div>
<div class="well">
<h3>About deecd</h3>
<p>deecd is a modified Moodle bootstrap theme which inherits styles and renderers from its parent theme.</p>
<h3>Parents</h3>
