...
<head>
    ...
    <noscript>
			<link rel="stylesheet" type="text/css" href="<?php echo $CFG->wwwroot;?>/theme/matrix/style/nojs.css" />
	</noscript>
    <!-- Google web fonts -->
...
<!-- End Frontpage Content -->
	...
	<div class="hidden-blocks">
    	<div class="row-fluid">
        	<h4><?php echo get_string('visibleadminonly', 'theme_matrix') ?></h4>
            <?php
                echo $OUTPUT->matrixblocks('hidden-dock');
            ?>
    	</div>
	</div>
	<?php } ?>
