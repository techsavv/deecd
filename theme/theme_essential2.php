...
/* Core */
$string['configtitle'] = 'essential2';
$string['pluginname'] = 'essential2';
$string['choosereadme'] = '
<div class="clearfix">
<div class="well">
<h2>essential2</h2>
<p><img class=img-polaroid src="essential2/pix/screenshot.jpg" /></p>
</div>
<div class="well">
<h3>About essential2</h3>
<p>essential2 is a modified Moodle bootstrap theme which inherits styles and renderers from its parent theme.</p>
<h3>Parents</h3>
